...
test("formatLineNumberedWhiteboard prefixes each element with padded line numbers", () => {
  assert.equal(
    formatLineNumberedWhiteboard([
      { type: "text", id: "title", x: 72, y: 68, text: "Lumen Light Whiteboard Prototype" },
      { type: "rectangle", id: "voice", x: 80, y: 140, width: 220, height: 80 },
    ]),
    [
      '001: {"type":"text","id":"title","x":72,"y":68,"text":"Lumen Light Whiteboard Prototype"}',
...
test("applyWhiteboardEditOperations can insert into an empty whiteboard", () => {
  assert.deepEqual(
    applyWhiteboardEditOperations([], [
      { type: "insert_after", line: 0, element: { type: "text", id: "title", x: 72, y: 68, text: "Lumen Light Whiteboard Prototype" } },
    ]),
    [{ type: "text", id: "title", x: 72, y: 68, text: "Lumen Light Whiteboard Prototype" }],
  );
});
