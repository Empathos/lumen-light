...
export async function runSimulation(options, agentProvider) {
  ...
  try {
    ...
    chromeUserDataDir = await mkdtemp(path.join(tmpdir(), "lumen-light-whiteboard-prototype-sim-chrome-"));
...
description: Simulate the Lumen Light Whiteboard Prototype whiteboard agent with Codex non-fast mode and capture trajectory artifacts.
